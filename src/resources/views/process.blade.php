...
@section('content')
    <div class="max-w-3xl mx-auto my-12">
        <div class="text-center mb-8">
            <h1 class="text-2xl mb-4">Projet <span class="font-semibold">{{ $process->id }}</span></h1>
        ...
        @if ($process->summary)
            <h3 class="text-xl font-semibold text-center mb-2">Résumé</h3>
            <p class="mb-12">{{ $process->summary }}</p>
        @endif
        @if ($process->chapters)
            <h3 class="text-xl font-semibold text-center mb-2">Chapitres</h3>
            <div class="mb-12">
        ...
        @endif
        @if ($process->transcript)
            <h3 class="text-xl font-semibold text-center mb-2">Sous-Titres</h3>
            <div>
